...
// wrapEffect can't infer the impl's custom props, so surface them explicitly
const WrappedRetroEffect = wrapEffect(RetroEffectImpl) as unknown as React.ForwardRefExoticComponent<
  { colorNum: number; pixelSize: number } & React.RefAttributes<RetroEffectImpl>
>;
...
function DitheredWaves({
  ...
  // useMemo (not a ref) so the uniforms object can be read during render for the material
